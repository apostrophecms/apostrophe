            ...
            notifications: notifications.map(item => `
              <div class="apos-confirm--${item.type}">
                ...
                <div class="apos-confirm__notificaton-meta">
                  <span class="apos-confirm__notification-title">${item.doc.title}</span> <span class="apos-confirm__notification-item-type">${this.$t(this.singular(item.doc.type))}</span>
                </div>
              </div>
            `),
