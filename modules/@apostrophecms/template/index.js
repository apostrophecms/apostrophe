    ...
    return {
      ...
      async renderPageForModule(req, template, data, module) {
        ...
        try {
          ...
          const filledContent = addExtraBundles({
        ...
        function addExtraBundles ({
          ...
          const renderMarkup = renderBundleMarkup(self.apos.asset.getAssetBaseUrl());
        ...
        function loadAllBundles({
          ...
          const jsBundles = extraBundles.js.reduce((acc, bundle) => {
          ...
          const cssBundles = extraBundles.css.reduce((acc, bundle) => {
            const bundleMarkup = renderMarkup({
              fileName: bundle.replace('.css', ''),
              ext: 'css'
            });
        ...
        function renderBundleMarkup (base) {
          return ({
