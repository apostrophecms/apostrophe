...
* Allows to pass `targetId` and `position` in options of the `publish` method. Passed by default during autopublish if it was existing in the body of the post request. 
