...
* Destroy `AreaEditor` Vue apps when the page is refreshed. This avoids a leak of Vue apps components being recreated while instances of old ones are still alive.
