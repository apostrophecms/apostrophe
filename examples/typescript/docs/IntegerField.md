...
**def** | **number** | Default integer value shown in the editor UI. | [optional] [default to undefined]
...
```typescript
import { IntegerField } from 'apostrophecms-client';

const instance: IntegerField = {
    type,
    label,
    help,
    htmlHelp,
