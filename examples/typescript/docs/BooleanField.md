...
**def** | **boolean** | Default value shown in the editor UI. | [optional] [default to undefined]
...
```typescript
import { BooleanField } from 'apostrophecms-client';

const instance: BooleanField = {
    type,
    label,
    help,
    htmlHelp,
