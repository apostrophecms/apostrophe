...
**_ancestors** | [**Array&lt;PageSummary&gt;**](PageSummary.md) | Array of ancestor pages (for breadcrumbs) | [optional] [default to undefined]
**_children** | [**Array&lt;PageTreeResponse&gt;**](PageTreeResponse.md) | Array of child pages (nested structure) | [optional] [default to undefined]
...
**results** | [**Array&lt;FlatPageResponseResultsInner&gt;**](FlatPageResponseResultsInner.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PageGet200Response } from 'apostrophecms-client';

const instance: PageGet200Response = {
    _id,
    orphan,
    visibility,
    type,
