...
**def** | **string** | Default value in HH:MM:SS (24-hour). If not set and not required, defaults to the current time.  | [optional] [default to undefined]
...
```typescript
import { TimeField } from 'apostrophecms-client';

const instance: TimeField = {
    type,
    label,
    help,
    htmlHelp,
