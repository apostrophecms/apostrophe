    ...
    const expected = {
      docs: [
        ...
        },
        {
          ...
          metaType: 'doc',
          modified: false,
          path: `${homeDraft.aposDocId}/${customDraft.aposDocId}/${importedDocs.at(2).aposDocId}`,
          rank: 0,
          searchSummary: '',
          slug: '/custom/custom-level-2-page-1/custom-level-3-page-1',
          title: 'Custom Level 3 Page 1',
        ...
        },
        {
          ...
          metaType: 'doc',
          orphan: false,
          path: `${homePublished.aposDocId}/${customPublished.aposDocId}/${importedDocs.at(3).aposDocId}`,
          parked: null,
          parkedId: null,
          rank: 0,
          searchSummary: '',
