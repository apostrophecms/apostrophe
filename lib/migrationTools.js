...
module.exports = function(self) {
  ...
  // does update the other. Of course it is your responsibility to save the change
  // via MongoDB (`apos.pages.update`).
  ...
  // update the other. Of course it is your responsibility to save the change
  // via MongoDB (`apos.pages.update`).
