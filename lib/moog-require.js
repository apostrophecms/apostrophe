...
module.exports = function(options) {
  ...
  function getNpmPath(parentPath, type) {
    ...
    // Even if the package exists in node_modules it might just be a sub-dependency
    // due to npm flattening, which means we could be confused by an unrelated npm module
    // with the same name as an Apostrophe module unless we verify it is a real
