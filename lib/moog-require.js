...
module.exports = function(options) {
  ...
  self.define = function(type, definition, extending) {
    ...
    // app.js wins. However if an option exists in index.js and not
    // in app.js, that should be honored, like it was in 2.x when
    // options were not a separate section yet.
