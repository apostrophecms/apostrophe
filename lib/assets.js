...
module.exports = {
  ...
  construct: function(self) {
    ...
    self.endAssets = function(options, callback) {
      ...
      if (argv._.length) {
        // 0.4 only minifies when acting directly as
        // a webserver. If there are positional command
        // line arguments, this is a task, and we
        // shouldn't waste time minifying. There's no
        // ambiguity because 0.4 has no apostrophe:generate task.
