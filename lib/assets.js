...
module.exports = {
  ...
  construct: function(self) {
    ...
    self.mixinModuleAssets = function(module, name, dirname, options) {
      ...
      module.render = function(name, data, req, res) {
        return module.renderer(name, req, res)(data);
      };
      ...
      module.renderer = function(name, req, res) {
        // console.log('renderer with name', name, typeof req, typeof res);
        return function(data) {
          if (!data) {
            data = {};
          }
          _.defaults(data, module._rendererGlobals);
          return self.partial(req, res, name, data, _.map(module._modules, function(module) { return module.dir + '/views'; }));
        };
      };
      ...
      //
      // The aposReady event is always triggered on the body, whether performing
      // an AJAX update or a fully decorated page rendering.
      //
      ...
      module.renderPage = function(req, res, template, data, when) {
        ...
        if (typeof(template) === 'string') {
          content = module.render(template, args, req, res);
        } else {
        ...
        if (req.xhr || req.query.xhr || (req.decorate === false)) {
          ...
          return self.decoratePageContent(args, req, res);
        }
      };
