apos.define('apostrophe-browser-utils', {
  construct: function(self, options) {
    ...
    self.action = function(sel, verb, subject, callback) {
      ...
      var attribute;
      if (subject === null) {
        attribute = '[data-' + self.cssName(verb) + ']';
      } else {
        attribute = '[data-' + self.cssName(verb) + '-' + self.cssName(subject) + ']';
      }
      $(sel).on('click', attribute, function() {
        callback($(this).attr(attribute));
        return false;
      });
    };
