...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    if (!options.enableAltField) {
      self.apos.utils.warnDev('⚠️ We recommend to add enableAltField: true in apostrophe-images options, see https://docs.apostrophecms.org/reference/modules/apostrophe-images/#apostrophe-images');
    }
