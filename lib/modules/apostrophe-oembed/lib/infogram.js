...
module.exports = function(self, oembetter) {
  ...
  oembetter.addBefore(async function(url, options, response, cb) {
    ...
    return cb(null, url, options, { thumbnail_url: 'https://infogr.am/infogram.png', title: title || 'Infogram', type: 'rich', html: '<div id="' + anchorId + '"></div>' + self.afterScriptLoads("//e.infogr.am/js/embed.js", anchorId, 'infogram_0_' + slug, ';')});
  });
};
