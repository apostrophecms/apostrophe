apos.define('apostrophe-areas', {
  ...
  construct: function(self, options) {
    ...
    self.enableCkeditor = function() {
      ...
      //
      //
      // begin extra CKEDitor fields
      //
      //

      CKEDITOR.config.extraAllowedContent = 'a[data-*]';
      ...
      var extraLinksTabs = [{
        ...
        fields: [
          {
            name: 'data-something-cool',
            label: 'Something Cool'
          },
          {
            name: 'data-another-thing',
            label: 'Another Thing'
          }
        ]
      }, {
      ...
      CKEDITOR.on('dialogDefinition', function (evt) {
        ...
        // set up to super-pattern the functions that push and pull from the DOM
        ...
        linkPlugin.parseLinkAttributes = function (editor, element) {
          ...
          _.each(extraLinksTabs, function (tab) {
        ...
        if (dialog.name == 'link') {
          ...
          // TOM i dont think we used this for anything? (obvs)
          // var superOnShow = def.onShow;
          // def.onShow = function (e) {
          //   superOnShow.call(this, e);
          // };
