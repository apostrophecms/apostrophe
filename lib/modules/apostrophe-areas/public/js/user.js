apos.define('apostrophe-areas', {
  ...
  construct: function(self, options) {
    ...
    // Handles the hovering of widgets and reveals only the controls on the directly
    // hovered widget, not the parent wrapper widget
    self.enhanceControlsHover = function() {

      var mouseoverEnhance = function($el) {
      ...
      var mouseleaveEnhance = function($el) {
      ...
      // on enhance, register new events to the widget
      // apos.on('enhance', function($el) {
      //   mouseoverEnhance($el);
      //   mouseleaveEnhance($el);
      // });

      apos.on('enhance', function($el) {
        console.log('ENHANCING');
        var $widgets = $el.find('[data-apos-widget]').addBack('[data-apos-widget]');
        $widgets.each(function(){
          mouseoverEnhance($(this));
          mouseleaveEnhance($(this));
        });
      });



      // Initialize for widgets already on the page at load
      // $('[data-apos-widget]').each(function(){
      //   mouseoverEnhance($(this));
      //   mouseleaveEnhance($(this));
      // })
