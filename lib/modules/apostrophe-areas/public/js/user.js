  ...
  construct: function(self, options) {
    ...
    self.enhanceAddContent = function() {
      ...
      $body.on('click', '[data-apos-add-content]', function(e) {
        ...
        $(this).closest('.apos-ui').toggleClass('apos-active');
      });
    }
    ...
    self.enhanceControlsHover = function(sel) {
      ...
      function mouseoverEnhance($el) {
        $el.on('mouseover', function(e) {
          var $self = $(this);
          e.stopPropagation();
          $('.apos-ui').removeClass('apos-peek');
          console.log($self);
          // $('[data-apos-area-controls]').removeClass('apos-peek');
          // $self.find('[data-apos-area-controls]').addClass('apos-peek');
          $self.children('.apos-ui').addClass('apos-peek');
        });
      };
      ...
      function mouseleaveEnhance($el) {
        $el.on('mouseleave', function(e) {
          var $self = $(this);
          // $self.find('[data-apos-area-controls]').removeClass('apos-peek');
          $self.find('[data-apos-widget-controls]:first .apos-ui').removeClass('apos-peek');
        });
      }
