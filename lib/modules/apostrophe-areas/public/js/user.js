apos.define('apostrophe-areas', {
  ...
  construct: function(self, options) {
    ...
    self.enhanceControlsHover = function() {
      $('[data-apos-widget]').mouseover(function(e){
        e.stopPropagation();
        $('.apos-area-widget-controls').css('opacity', 0);
        $(this).find('[data-apos-widget-controls]:first .apos-area-widget-controls').css('opacity', 0.4);
      });

      $('[data-apos-widget]').mouseleave(function(){
        $(this).find('[data-apos-widget-controls]:first .apos-area-widget-controls').css('opacity', 0);
      });
    }
