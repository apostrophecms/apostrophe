...
apos.define('apostrophe-area-editor', {
  ...
  construct: function(self, options) {
    ...
    self.enhanceExistingWidgetControls = function() {
      ...
      $items = self.$el.findSafe('[data-widget]', '[data-area]');
      $items.each(function() {
        var $widget = $(this);
    ...
    self.linkItemsToAreaEditor = function() {
      ...
      var $items = self.$el.findSafe('[data-widget]', '[data-area]');
      $items.each(function() {
        var $item = $(this);
    ...
    self.serialize = function() {
      var items = [];
      self.$el.findSafe('[data-widget]', '[data-area]').each(function() {
        var $item = $(this);
    ...
    self.respectLimit = function() {
      var count = self.$el.findSafe('[data-widget]', '[data-area]').length;
