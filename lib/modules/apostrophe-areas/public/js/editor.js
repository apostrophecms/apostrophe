...
apos.define('apostrophe-area-editors', {
  ...
  construct: function(self, options) {
    ...
    self.enableCkeditor = function() {
      ...
      // Tell CKEDITOR where it really lives in spite
      // of the fact that the core code has been
      // included in our minification
      window.CKEDITOR_BASEPATH = apos.prefix + self.options.action + '/js/vendor/ckeditor/';
