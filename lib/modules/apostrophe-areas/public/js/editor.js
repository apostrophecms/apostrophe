...
apos.define('apostrophe-area-editor', {
  ...
  construct: function(self, options) {
    ...
    self.init = function() {
      ...
      self.on('click', '[data-add-item-type]', function() {
      ...
      self.on('click', '[data-edit-item]', function(event) {
      ...
      self.on('click', '[data-move-item]', function(e) {
        var $self = $(this);
      ...
      self.on('click', '[data-lockup-type]', function(event) {
      ...
      self.on('click', '[data-trash-item]', function() {
        var $item = $(this).closest('[data-widget],.apos-lockup');
        return self.trashItem($item);
      });

      self.on('click', '[data-content-menu-toggle]', function() {
      ...
      self.on('click', '[data-add-item]', function() {
        var $item = $(this).closest('[data-widget],.apos-lockup');
      ...
      self.on('click', '[data-unlock-item]', function() {
        var $lockup = $(this).closest('.apos-lockup');
    ...
    self.addButtonsToItem = function($item) {
      ...
      if (self.isItemLocked($item) && !self.isText($item)) {
        $itemButtons = self.fromTemplate('[data-locked-item-buttons]');
      } else if (self.isItemLocked($item)) {
        $itemButtons = self.fromTemplate('[data-lockup-buttons]');
      } else {
        $itemButtons = self.fromTemplate('[data-area-item-buttons]');
      }
