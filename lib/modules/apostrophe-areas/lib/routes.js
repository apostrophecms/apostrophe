...
module.exports = function(self, options) {
    ...
    return async.eachSeries(items, function(item, callback) {
      ...
      return async.series({
        sanitize: function(callback) {
          ...
          return manager.sanitize(req, item, widgetOptions, function(err, _widget) {
            if (err) {
              return callback(err);
            }
            widget = _widget;
  ...
  self.route('post', 'render-widget', function(req, res) {
    ...
    return async.series({
      sanitize: function(callback) {
        return manager.sanitize(req, widget, options, function(err, _widget) {
          if (err) {
            return callback(err);
          }
          widget = _widget;
