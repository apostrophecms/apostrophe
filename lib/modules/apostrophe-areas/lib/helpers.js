...
module.exports = function(self, options) {
  self.addHelpers({
    ...
    singleton: function(doc, name, type, _options) {
      ...
      console.warn('TODO: replace apos.singleton with new area extension');
      return self.apos.templates.safe('UNIMPLEMENTED');
    ...
    area: function(doc, name, _options) {
      ...
      console.warn('TODO: replace apos.area with new area extension');
      return self.apos.templates.safe('UNIMPLEMENTED');
    ...
    widget: function(widget, options) {
      let manager = self.getWidgetManager(widget.type);
      if (!manager) {
      ...
      return self.apos.templates.safe(manager.output(req, widget, options));
    },
