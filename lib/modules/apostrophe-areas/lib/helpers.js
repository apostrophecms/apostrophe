...
module.exports = function(self, options) {
  self.addHelpers({
    ...
    // be used to append additional control groups. See the source for
    // the format (TODO: document in detail).
    
    widgetControlGroups: function() {
      var controlGroups = ([
        {
          classes: '',
          controls: [
      ...
      self.apos.emit('widgetControlGroups', controlGroups);
