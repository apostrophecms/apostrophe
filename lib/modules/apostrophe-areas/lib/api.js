...
module.exports = function(self, options) {
  ...
  self.forbiddenAreas = [ '_id', 'title', 'slug', 'sortTitle', 'docPermissions', 'tags', 'type' ];
  ...
  self.saveSingleton = function(req, docId, dotPath, data, options, callback) {
    ...
    return self.saveArea(req, docId, dotPath, [ data ], options, function(err) {
      if (err) {
        return callback(err);
      }
      return self.renderWidget(req, data, options, callback);
    });
  };
