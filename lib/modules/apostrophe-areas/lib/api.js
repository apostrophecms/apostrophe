...
module.exports = function(self, options) {
  ...
  self.renderArea = async function(req, area, options) {
  ...
  self.renderWidget = async function(req, type, data, options) {
    ...
    const output = await manager.output(req, data, options);
  ...
  self.lockSanitizeAndSaveArea = async function(req, areaInfo) {
    ...
    async function sanitizeItems() {
      return self.sanitizeItems(req, items);
    }
  ...
  self.blessedError = function(item, widgetOptions) {
