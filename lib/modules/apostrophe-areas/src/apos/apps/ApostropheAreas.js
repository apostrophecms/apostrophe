...
export default function() {
  ...
  async function save() {
    ...
    try {
      console.log(docIds, itemsByParentId);
  ...
  function createAreaApp(el) {
    ...
    console.log(docId, dotPath, parentId);
    ...
    return new Vue({
      ...
      methods: {
        changed(items) {
          console.log('changed');
          itemsByParentId[this.parentId] = itemsByParentId[this.parentId] || {};
          itemsByParentId[this.parentId][this.areaName] = items;
          save();
        }
      },
