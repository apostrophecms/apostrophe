...
module.exports = {
  ...
  afterConstruct: function(self) {
    self.apos.tasks.add('apostrophe', 'generation',
      ...
      'with the APOS_EXTRACT_BUNDLE environment variable set to the same NAME.',
      function(apos, argv, callback) {
      // This task is actually implemented in afterInit for chicken and egg reasons,
    ...
    self.determineGeneration = function() {
      ...
      if (self.isGenerationTask) {
        ...
        if (self.apos.argv['create-bundle']) {
          self.toBundle = self.apos.rootDir + '/' + self.apos.argv['create-bundle'];
