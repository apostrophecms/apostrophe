...
// Wrap webpack so that parse errors and webpack internal errors
// both pass an error to the callback; we'll promisify it before use
...
module.exports = {
  ...
  construct: function(self, options) {
    self.addTask('build', 'Build Apostrophe frontend javascript master import file', async (apos, argv) => {
...
`
      ...
      return await Promise.promisify(webpack)({
        entry: importFile,
        mode: 'development',
        optimization: {
          minimize: false
