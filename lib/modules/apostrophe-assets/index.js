...
// ### `serveStaticOptions`
//
// Pass options to the [serve-static](https://github.com/expressjs/serve-static/)
// Express middleware, such as `Cache-Control` and more. If no options are defined,
// the default options from the middleware will be used. Please note these options
// only take effect if you set `minifiy: true`. This is to ensure up to date assets
  ...
  construct: function(self, options) {
    ...
    self.servePublicAssets = function() {
      ...
      middleware.push(self.apos.express.static(
        ...
        _.defaults({}, self.options.minify === true ? self.options.serveStaticOptions : {}))
      );
