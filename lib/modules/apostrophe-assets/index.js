...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.extractBundleFromGenerationCollection = function() {
      ...
      return Promise.try(function() {
        // A projection categorically should not be needed here, but without it,
        // we have observed mongodb refusing to return anything except _id. This may
        // be linked to an extremely large, but not illegally large, tarball property
        // (over 9mb)
        return self.generationCollection.findOne({ _id: self.getThemed('current') }, { tarball: 1 });
