...
var apos = window.apos = {
  ...
  define: function(typeName, definition) {
    return apos.synth.define.apply(apos.synth, arguments);
  },

  redefine: function(typeName, definition) {
    return apos.synth.redefine.apply(apos.synth, arguments);
  },

  create: function(typeName, options /* , callback */) {
    return apos.synth.create.apply(apos.synth, arguments);
  }
};
