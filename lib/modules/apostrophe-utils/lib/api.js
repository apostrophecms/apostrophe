...
module.exports = function(self, options) {
  ...
  self.md5File = async function(filename) {
    return Promise.promisify(body)(filename);
    function body(cb) {
      let md5 = crypto.createHash('md5');
  ...
  self.fileLength = async function(filename) {
  ...
  self.bless = function(req, options /* , arg2, arg3... */) {
    let hash = self.hashBlessing(Array.prototype.slice.call(arguments, 1));
