...
module.exports = function(self, options) {
  ...
  self.findSubobjectById = function(object, id) {
    var key;
    var val;
    var result;
    for (key in doc) {
      ...
      if (val && (typeof(val) === 'object')) {
        ...
        result = self.findSubobjectById(val, id);
        if (result) {
          return result;
        }
      }
  ...
  self.findSubobjectAndDotPathById = function(object, id, _dotPath) {
    var key;
    var val;
    var result;
    var subPath;
    ...
    for (key in object) {
      ...
      if (val && (typeof(val) === 'object')) {
        ...
        result = self.findSubobjectAndDotPathById(val, id, subPath);
        if (result) {
          return result;
        }
      }
