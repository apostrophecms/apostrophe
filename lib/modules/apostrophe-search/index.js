...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    // Removes redundant properties that are useful for
    // search but not essential to recreate the doc on
    // a new update

    self.docVersionPrune = function(req, version) {
      delete version.sortTitle;
      delete version.highSearchText;
      delete version.highSearchWords;
      delete version.lowSearchText;
      delete version.searchSummary;
    };
  }
}
