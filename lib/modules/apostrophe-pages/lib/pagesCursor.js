  ...
  construct: function(self, options) {
    ...
    self.addFilter('children', {
      ...
      after: function(results, callback) {
        ...
        // This is an $or query that can't be eliminated without a
        // schema overhaul to store something like:
        //
        // ancestors: [ 'l1xxx', 'l2yyyy' ]
        //
        // So we can find things that are both the right depth of
        // ancestor and the right id in a single $in query.
        //
        // However using $or still optimizes it to a single roundtrip in
        // latency terms, and it appears most sites don't actually have
        // more than one clause in the $or anyway.
        //
        // So at least for 2.x we keep it this way. -Tom
