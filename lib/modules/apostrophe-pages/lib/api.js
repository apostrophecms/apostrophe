...
module.exports = function(self, options) {
  ...
  self.addPermissions = function() {
    if (self.apos.permissions.extended) {
      ...
      self.apos.permissions.add({
        value: 'trash-apostrophe-page',
        label: 'And Trash Page'
      });
      self.apos.permissions.add({
        value: 'insert-apostrophe-page',
        label: 'Create a New Page'
      });
      // This exists to make it easier to revoke per-piece permissions quickly
      self.apos.permissions.add({
        value: 'update-apostrophe-page',
        label: 'Edit Specific Page'
      });
    } else {
      self.apos.permissions.add({
        value: 'admin-apostrophe-page',
