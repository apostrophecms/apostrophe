...
module.exports = function(self, options) {
  ...
  self.insert = function(req, parentOrId, page, callback) {
    var parent;
    self.denormalizePermissions(req, page);
    return async.series({
      ...
      beforeInsert: function(callback) {
        return self.beforeInsert(req, page, callback);
      },
      beforeSave: function(callback) {
        return self.beforeSave(req, page, callback);
      },
  ...
  // Apostrophe edits page editing and viewing permissions via joins,
  ...
  // or a group id. This method performs that copying.

  self.denormalizePermissions = function(req, page) {
    ...
    _.each(fields, function(prefix, name) {
      docPermissions = docPermissions.concat(
        _.map(page[name] || [], function(id) {
          return prefix + '-' + id;
        })
      );
    });
    page.docPermissions = docPermissions;
  };
  ...
  self.propagatePermissions = function(req, page, callback) {
  ...
  self.update = function(req, page, callback) {
    self.denormalizePermissions(req, page);
    return async.series({
      propagatePermissions: function(callback) {
        return self.propagatePermissions(req, page, callback);
      },
      beforeUpdate: function(callback) {
        return self.beforeUpdate(req, page, callback);
      },
      beforeSave: function(callback) {
        return self.beforeSave(req, page, callback);
      },
  ...
  self.setManagerForUnspecifiedPageType = function() {
  ...
  self.beforeSave = function(req, page, callback) {
    return setImmediate(callback);
  };
  ...
  self.beforeInsert = function(req, page, callback) {
    return setImmediate(callback);
  };
  ...
  self.beforeUpdate = function(req, page, callback) {
    return setImmediate(callback);
  };
