...
module.exports = function(self, options) {
  ...
  self.trashInSchema = function(req, _id, toTrash, callback) {
    ...
    [
      ...
      function doDupe(cb) {
        self.apos.docs.db.update({ path: self.matchDescendants(page) }, action, (err, pages) => {
          return self.handleDeduplication(req, pages, toTrash, cb)
        });
      },
  ...
  self.handleDeduplication = function(req, pages, toTrash, callback) {
