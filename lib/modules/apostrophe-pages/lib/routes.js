...
module.exports = function(self, options) {
  ...
  self.apiRoute('post', 'fetch-to-insert', async function(req, res) {
    // parent id
    ...
    return { page: child, schema: self.allowedSchema(req, child, parentPage) };
  });
  ...
  self.apiRoute('post', 'insert', async function(req, res) {
  ...
  self.apiRoute('post', 'fetch-to-update', async function(req, res) {
  ...
  self.apiRoute('post', 'update', async function(req, res) {
    let page = req.body;
    if ((typeof page) !== 'object') {
      // cheeky
      throw 'notfound';
