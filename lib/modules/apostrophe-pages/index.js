...
//
// **`trashInTree`: if set to `true`, trashcans appear for each "folder"
// (parent page), rather than a single shared trashcan. This allows pages to be
// restored to their exact previous position and decouples moving pages from
// trashing pages, which is useful for the `apostrophe-workflow` module.
// In addition, it becomes possible to edit the page settings of a page that is
// in the trash.
