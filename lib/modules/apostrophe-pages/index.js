...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    // Route that serves pages. See afterInit above for the
    // wildcard argument and the app.get call
    ...
    self.serveLoaders = function(req, callback) {
      ...
      // Jimmy's Page Service Magix
      return self.people.pageServe(req, callback);
    };
