...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.enableTwoFactor = function() {
      self.passport.use(new TotpStrategy(self.verify2FA));
    };
    ...
    self.verify2FA = function(username, callback) {
      console.log('verifing2FA...');
    };
    ...
    self.addRoutes = function() {
      ...
      if (self.options.enable2FA) {
        self.apos.app.get('/setup', self.verify2FA, function(req, res, next) {
          return self.sendPage(req, 'setup');
        });
      }
