...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.compare = function(old, current) {
      ...
      var diff = jsDiff.diffSentences(self.apos.utils.htmlToPlaintext(old.content).replace(/\s+/g, ' '), self.apos.utils.htmlToPlaintext(current.content).replace(/\s+/g, ' '), { ignoreWhitespace: true });
