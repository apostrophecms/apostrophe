...
module.exports = function(self, options) {
  ...
  self.deduplicateTrash = async function(req, doc) {
    ...
    return self.apos.docs.db.update({ _id: doc._id }, { $set: $set });
  };

  self.on('afterTrash', self.deduplicateTrash);
  ...
  self.deduplicateRescue = async function(req, doc) {
    ...
    async function update() {
      ...
      return self.apos.docs.db.update({ _id: doc._id }, action);
    }
  };

  self.on('afterRescue', self.deduplicateRescue);
