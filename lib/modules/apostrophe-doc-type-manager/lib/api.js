...
module.exports = function(self, options) {
  ...
  // Returns the minimum permission name that should be checked for to determine
  // if this user has full admin privileges for this doc type.
  // Used to build query criteria by type as well as various UI
