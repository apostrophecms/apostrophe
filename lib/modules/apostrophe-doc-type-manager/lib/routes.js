...
module.exports = function(self, options) {
  ...
  self.route('post', 'chooser-choices', function(req, res) {
    ...
    return async.series({
      ...
      var markup = self.render(req, choicesTemplate, { field: field, choices: choices, choiceTemplate: choiceTemplate, relationship: field.relationship, hints: field.hints });
