...
module.exports = function(self, options) {
  ...
  self.apiRoute('post', 'chooser', async function(req) {
    ...
    return await self.render(req, 'chooser', { browse: browse, autocomplete: autocomplete });
  });
  ...
  self.apiRoute('post', 'chooser-choices', async function(req) {
    ...
    const choices = receptacle[field.name];
  ...
  self.apiRoute('post', 'autocomplete', async function(req, res) {
    ...
    return await self.autocomplete(req, { field: field, term: term });
  });
