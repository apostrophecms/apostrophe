...
module.exports = {
  ...
  methods(self, options) {
    return {
      ...
      // [@apostrophecms/pieces-pages](../@apostrophecms/pieces-pages/index.html) will
      // call `setAddUrls` to point to [its own `addUrlsToPieces` method](../@apostrophecms/pieces-pages/index.html#addUrlsToPieces).
      async addUrls(req, pieces) {
      },
      // Called by [@apostrophecms/pieces-pages](../@apostrophecms/pieces-pages/index.html) to
      ...
      // See [the `addUrlsToPieces` method of `@apostrophecms/pieces-pages`](../@apostrophecms/pieces-pages/index.html#addUrlsToPieces).
      setAddUrls(fn) {
        self.addUrls = fn;
      },
