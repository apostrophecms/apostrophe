  ...
  handlers(self, options) {
    return {
      'apostrophe:modulesReady': {
        addListTask() {
          return self.addTask('list', 'Usage: node app @apostrophecms/permissions:list', function () {
  ...
  methods(self, options) {
    return {
      ...
      getEffectiveTypeName(type) {
        ...
        if (self.apos.instanceOf(manager, '@apostrophecms/custom-pages')) {
