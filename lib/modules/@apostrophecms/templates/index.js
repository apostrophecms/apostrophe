    ...
    return {
      ...
      addBodyDataAttribute(req, name, value) {
        ...
        _.each(values, (value, key) => {
          ...
          req.data.aposBodyDataAttributes = (req.data.aposBodyDataAttributes ? req.data.aposBodyDataAttributes + ' ' : ' ') + ('data-' + (!_.isUndefined(value) && value.toString().length > 0 ? self.apos.utils.escapeHtml(key) + (`='${self.apos.utils.escapeHtml(value, { single: true })}'`) : self.apos.utils.escapeHtml(key)));
        });
      },
