// The `@apostrophecms/users` module provides user accounts. It is **not** intended to
...
//
// Groups are managed by the `@apostrophecms/groups` module.
//
// There is also a simplified permissions model in which you just specify
// an array of `groups` as an option to `@apostrophecms/users`, and a single-select
...
// `@apostrophecms/users`, the admin interface for `@apostrophecms/groups` will hide itself.
//
...
// `@apostrophecms/users`. You can add it back in, but then you have to deal with
...
// or similar, extending `@apostrophecms/pieces`, unless it's true that basically
...
module.exports = {
  ...
  async init(self, options) {
    ...
    self.apos.tasks.add('@apostrophecms/users', 'add', 'Usage: node app @apostrophecms/users:add username groupname\n\n' + 'This adds a new user and assigns them to a group.\n' + 'You will be prompted for a password.', async function (apos, argv) {
      await self.addFromTask();
    });
    
    self.apos.tasks.add('@apostrophecms/users', 'change-password', 'Usage: node app @apostrophecms/users:change-password username\n\n' + 'This prompts you for a new password for the given user.', async function (apos, argv) {
  ...
  handlers(self, options) {
    return {
<<<<<<< HEAD:lib/modules/apostrophe-users/index.js
      beforeInsert: {
=======
      '@apostrophecms/users:beforeInsert': {
>>>>>>> 428e787d5b97d3039c5a9d6f1352c85e1bc45b30:lib/modules/@apostrophecms/users/index.js
...
<<<<<<< HEAD:lib/modules/apostrophe-users/index.js
      beforeUpdate: {
=======
      '@apostrophecms/users:beforeUpdate': {
>>>>>>> 428e787d5b97d3039c5a9d6f1352c85e1bc45b30:lib/modules/@apostrophecms/users/index.js
  ...
  methods(self, options) {
    return {
      ...
      // Implement the `@apostrophecms/users:add` command line task.
      ...
      // Implement the `@apostrophecms/users:change-password` task.
