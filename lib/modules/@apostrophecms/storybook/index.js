  ...
  methods(self, options) {
    return {
      async build(apos, argv) {
        ...
        const importsCode = imports.components.importCode + imports.icons.importCode + imports.tiptapExtensions.importCode;
        const componentsCode = imports.components.registerCode + imports.icons.registerCode + imports.tiptapExtensions.registerCode;
