...
module.exports = {
    ...
    return {
      post: {
        ...
        async dismiss(req) {
          ...
          await self.db.deleteMany({ _id: _id });
        }
      }
    };
  },
  ...
  methods(self, options) {
    return {
      ...
      getRestQuery(req) {
        return self.find(req).applyBuilders(req.query);
      }
    };
  },
  middleware(self, options) {
    return {
      ...
      // `/api/v1/@apostrophecms/notifications/poll`. It is implemented
