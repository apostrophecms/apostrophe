...
// The `@apostrophecms/jobs` module runs long-running jobs in response
// to user actions. Batch operations on pieces are a good example.
//
// The `@apostrophecms/jobs` module makes it simple to implement
...
// see the examples already in `@apostrophecms/pieces` and those added
...
//
// The `@apostrophecms/jobs` module DOES NOT have anything to do with
...
module.exports = {
  ...
  methods(self, options) {
    return {
      ...
      //
      // The `batchSimple` method of `@apostrophecms/pieces` is an even
