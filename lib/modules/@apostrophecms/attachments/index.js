            ...
            try {
              ...
              for (const file of (req.files || {})) {
                try {
                  ...
                  self.apos.utils.warn(`Uploaded temporary file ${file.path} was already removed, this should have been the responsibility of the upload route`);
                }
              }
            }
          }
  ...
  methods(self, options) {
    return {
      ...
      getMissingAttachmentUrl() {
        let defaultIconUrl = '/modules/@apostrophecms/attachments/img/missing-icon.svg';
      ...
      all(within, options) {
        ...
        self.apos.docs.walk(within, function (o, key, value, dotPath, ancestors) {
          if (test(value)) {
            ...
            // that cropping coordinates stored in an @apostrophecms/images widget
      ...
      async each(criteria, limit, each) {
        ...
        // tasks like @apostrophecms/attachments:rescale. We need a robust solution that
