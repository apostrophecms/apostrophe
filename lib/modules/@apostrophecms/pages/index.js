...
module.exports = {
      ...
      'apostrophe:modulesReady': {
        ...
        async manageOrphans() {
          ...
          async function manage() {
            ...
            self.apos.utils.error('* Providing an appropriate subclass of @apostrophecms/piece-type.');
            self.apos.utils.error();
  ...
  methods(self, options) {
    return {
      ...
      // Registers a manager for a specific page type that doesn't already have one via `@apostrophecms/page-type`,
      // `@apostrophecms/pieces-page-type`, etc. Invoked by `modulesReady` via `registerGenericPageTypes` and
      // `manageOrphans`
