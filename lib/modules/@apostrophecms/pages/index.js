        ...
        async manageOrphans() {
          ...
          for (const type of types) {
            if (!_.includes(managed, type)) {
              throw new Error(`The typeChoices option of the @apostrophecms/pages module contains type ${type}
but there is no module that manages that type. You must implement a module of that name that extends
@apostrophecms/pieces-type or @apostrophecms/pages-type with the same name, or remove the entry from
typeChoices.`);
            }
          }
...
but there is no module that manages that type. You must implement a module of that name that extends
@apostrophecms/pieces-type or @apostrophecms/pages-type with the same name, or remove these documents
from the database.`);
            }
          }
        }
