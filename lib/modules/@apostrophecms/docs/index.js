...
// is `apos.docs.find()`, which returns a [cursor](server-@apostrophecms/cursor.html) for
...
// moving pages from trashing pages, which is useful for the `@apostrophecms/workflow`
...
module.exports = {
  ...
  handlers(self, options) {
    return {
      ...
      '@apostrophecms/doc-type-manager:beforeSave': {
      ...
      '@apostrophecms/doc-type-manager:beforeUpdate': {
      ...
      '@apostrophecms/versions:unversionedFields': {
  ...
  methods(self, options) {
    return {
      ...
      find(req, criteria, projection) {
        return self.apos.modules['@apostrophecms/any-doc-type-manager'].find(req, criteria, projection);
      },
      ...
      // doc.type.
      //
      // If a unique key error occurs, the `@apostrophecms/docs:fixUniqueError`
      ...
      // is a module that subclasses `@apostrophecms/doc-type-manager`
      // (or its subclasses `@apostrophecms/pieces` and `@apostrophecms/custom-pages`).
      ...
      // with `@apostrophecms/pages` always have one).
      getManager(type) {
