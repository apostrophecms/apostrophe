...
// via an `XSRF-TOKEN` cookie. The `@apostrophecms/assets` module pushes
...
module.exports = {
  init(self, options) {
    ...
    if (self.options.baseUrl && !self.apos.baseUrl) {
      self.apos.utils.error('WARNING: you have baseUrl set as an option to the `@apostrophecms/express` module.');
    ...
    return {
      ...
      getSessionOptions() {
        ...
        if (sessionOptions.secret === 'you should have a secret') {
          self.apos.utils.error('WARNING: No session secret provided, please set the `secret` property of the `session` property of the @apostrophecms/express module in app.js');
        }
