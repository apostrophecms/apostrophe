...
//
// node app @apostrophecms/migrations:migrate
//
...
module.exports = {
  ...
  methods(self, options) {
    return {
      ...
      //
      // Examples (assume `products` extends `@apostrophecms/pieces`):
      //
      // `await self.apos.tasks.invoke('@apostrophecms/users:add', [ 'admin', 'admin' ])`
      //
