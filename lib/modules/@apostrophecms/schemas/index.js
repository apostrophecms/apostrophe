...
// [@apostrophecms/pieces](../@apostrophecms/pieces/index.html),
// [@apostrophecms/widgets](../@apostrophecms/widgets/index.html), custom field
// types in page settings for [@apostrophecms/custom-pages](../@apostrophecms/custom-pages/index.html)
// and more.
//
  ...
  init(self, options) {
    ...
    self.addFieldType({
      ...
      convert: async function (req, field, data, object) {
        ...
        items = await self.apos.areas.sanitizeItems(req, items, field);
        object[field.name] = {
          items,
          metaType: 'area'
        };
      ...
      getWidgetOptionsForPath(field, path) {
        ...
        const widgetOptions = field.options.widgets && field.options.widgets[name];
        if (!path.length) {
    ...
    return {
      ...
      joinDriver(req, method, reverse, items, idField, relationshipsField, objectField, options) {
        ...
        return method(items, idField, relationshipsField, objectField, function (ids) {
          ...
          query.applySafeBuilders(hints, 'manage');
      ...
      // @apostrophecms/doc-type-manager or a subclass), do not replace it.
      ...
      // Part of the implementation of PATCH routes.
      //
        ...
        function append(data) {
          _.each(data, function(val, key) {
            ...
            if (val && val.$each) {
              ...
              const existing = _.get(patch, key) || [];
              existing.push(val);
