  ...
  init(self, options) {
    ...
    self.addFieldType({
      ...
      convert: async function (req, field, data, object) {
        const _id = object[field.name]._id;
      ...
      implementPatchOperators(patch, existingPage) {
        ...
        if (patch.$push) {
          ...
          _.each(patch.$pullAll, function(val, key) {
            ...
            self.apos.utils.set(patch, key, _.differenceWith(self.apos.utils.get(patch, key) || [], self.apos.utils.get(patch.$pullAll, key) || [], function(a, b) {
          ...
          _.each(patch.$pullAllById, function(val, key) {
            ...
            self.apos.utils.set(patch, key, _.differenceWith(self.apos.utils.get(patch, key) || [], self.apos.utils.get(patch.$pullAllById, key), function(a, b) {
              return a._id === b;
            }));
          });
        }
        ...
        function cloneOriginalBase(key) {
          console.log(`${existingPage._id} ${key}`);
          if (key.charAt(0) === '@') {
