...
// allows you to create [@apostrophecms/schema](Apostrophe schema joins) that can link to
      ...
      builders: {
        ...
        children: {
          ...
          async after(results) {
            ...
            const subquery = self.apos.page.find(query.req).areas(false).joins(false).orphan(false);
