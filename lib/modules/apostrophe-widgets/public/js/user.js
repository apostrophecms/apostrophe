apos.define('apostrophe-widgets', {
  ...
  afterConstruct: function(self) {
    // Make sure the editor type and all of its intermediate types exist following the
    // same inheritance chain as this singleton
    apos.mirror(self.__meta, '-widgets-editor');
  },
