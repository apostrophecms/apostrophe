...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.output = async function(req, widget, options) {
      return self.render(req, self.template, { widget: widget, options: options, manager: self });
    };
    ...
    self.list = async function(apos, argv) {
