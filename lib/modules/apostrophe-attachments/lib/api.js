...
module.exports = function(self, options) {
  ...
  self.on('apostrophe-doc-type-manager:afterSave', 'updateDocReferencesAfterSave', async function(req, doc, options) {
    return self.updateDocReferences(doc);
  });

  self.on('apostrophe-doc-type-manager:afterTrash', 'updateDocReferencesAfterTrash', async function(req, doc) {
    return self.updateDocReferences(doc);
  });

  self.on('apostrophe-doc-type-manager:afterRescue', 'updateDocReferencesAfterRescue', async function(req, doc) {
    return self.updateDocReferences(doc);
  });
