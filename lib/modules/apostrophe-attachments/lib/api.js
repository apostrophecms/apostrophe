...
module.exports = function(self, options) {
  ...
  self.addFixOrientationsMigration = function() {
    self.apos.migrations.add(self.__meta.name + '.fixOrientations', function(callback) {
      return self.apos.migrations.each(
        ...
        function(attachment, callback) {
          if (attachment.width > attachment.height) {
            ...
            delete attachment.portrait;
          } else if (attachment.width < attachment.height) {
            attachment.portrait = true;

            delete attachment.landscape;
          } else {
            attachment.square = true;

            // Normally actually square was portrait, but to be sure we delete landscape too
            // No risk of error and no cost
            delete attachment.portrait;
            delete attachment.landscape;
          }
