...
module.exports = function(self, options) {
  ...
  // This method is available as a template helper: apos.attachments.getImageSize
  //
  // Look up an image size object by name. Helpful when you want to translate an
  // image size name to a pixel width.

  self.getImageSize = function(name) {
    return _.find(self.imageSizes, { name: name });
  };
