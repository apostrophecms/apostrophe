...
module.exports = function(self, options) {
  ...
  self.resetUploadfsPermissions = function(callback) {
    return self.apos.migrations.each(self.db, {}, 5, function(attachment, callback) {
      ...
      self.apos.utils.warn('^^^ WARNINGS ABOVE ARE OK. You may see some in cases where the permissions are already correct.');
      return callback(null);
    });

    return self.apos.migrations.eachDoc(self.db, {}, 5, function(doc, callback) {
