...
module.exports = function(self, options) {
  ...
  self.clone = function(req, source, callback) {
    ...
    return async.series([
      ...
      function(callback) {
        ...
        return self.uploadfs.copyIn(tempFile, '/attachments/' + target._id + '-' + target.name + '.' + target.extension, callback);
      },
      function(callback) {
  ...
  // There is a matching client-side implementation accessible as apos.path
