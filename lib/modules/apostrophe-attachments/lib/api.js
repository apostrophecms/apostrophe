...
module.exports = function(self, options) {
  ...
  self.insert = async function(req, file, options) {
    ...
    if (!group) {
      const accepted = _.union(_.pluck(self.fileGroups, 'extensions'));
  ...
  self.migrateToDisabledFileKeyTask = function(argv) {
    await Promise.promisify(self.uploadfs.migrateToDisabledFileKey)();
  };

  self.migrateFromDisabledFileKeyTask = function(argv) {
