...
module.exports = function(self, options) {
  ...
  // This method is available as a template helper: apos.attachments.srcset
  //
  // Given an attachment object, return a string that can be used as the value
  // of a `srcset` HTML attribute.

  self.srcset = function(attachment) {
    var sources = self.imageSizes.map(function(imageSize) {
      var src = self.url(attachment, { size: imageSize.name });
