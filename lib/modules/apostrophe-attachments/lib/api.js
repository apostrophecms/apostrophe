...
module.exports = function(self, options) {
  ...
  // a valid focal point has been specified.
  ...
  self.hasFocalPoint = function(attachment) {
    ...
    if ((typeof(attachment.x) === 'number') && (typeof(attachment.y) === 'number')) {
      return true;
    }
  ...
  // The coordinates are in percentage terms, based on the crop associated
  // with the attachment.
  ...
  self.focalPointToBackgroundPosition = function(attachment) {
    ...
    // Work with any combo of direct/joined crops and direct/joined focal points
    var width = attachment._crop ? attachment._crop.width : attachment.width;
    var height = attachment._crop ? attachment._crop.height : attachment.height;
    ...
    console.log(x, y, width, height, (x / width) * 100, (y / height) * 100);
