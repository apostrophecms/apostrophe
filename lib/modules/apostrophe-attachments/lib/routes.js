...
module.exports = function(self, options) {
  ...
  self.route('post', 'crop-editor', self.middleware.canUpload, async function(req, res) {
    return res.send(await self.render(req, 'cropEditor', {}));
  });

  self.route('post', 'focal-point-editor', self.middleware.canUpload, function(req, res) {
    return res.send(await self.render(req, 'focalPointEditor', {}));
  });
