  ...
  methods(self, options) {
    return {
      ...
      getMissingAttachmentUrl() {
        let defaultIconUrl = '/modules/apostrophe-attachments/img/missing-icon.svg';
