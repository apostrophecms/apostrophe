  ...
  construct: function(self, options) {
    ...
    self.addPermissions = function() {
      self.apos.permissions.add({
        ...
        label: 'Upload Media',
        def: true,
        description: 'Users with this permission are permitted to upload media. As a general rule, you should always check this box for users who will be creating content on the site.'
      });
    };
