...
apos.define('apostrophe-attachments-focal-point-editor', {
  ...
  construct: function(self, options) {
    ...
    self.afterShow = function() {
      ...
      self.croppedTop = self.croppedWidth ? options.crop.top : 0;
      self.croppedLeft = self.croppedWidth ? options.crop.left : 0;
      var boxWidth = self.$focalPointImageBox.width();
      var boxHeight = self.$focalPointImageBox.height();
      console.log(self.croppedWidth, self.croppedHeight, boxWidth, boxHeight);
      ...
      console.log('attachments.url arguments:');
      console.log({ size: 'original', crop: options.crop });
