...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    // Before sending any page, create the singleton, but only
    ...
    self.getCreateSingletonOptions = function(req) {
      var browserOptions = {};
      _.defaults(browserOptions, self.options.browser || {});
      browserOptions.action = browserOptions.action || self.action;
      console.log('BROWSER OPTIONS FOR CHOOSERS');
    ...
    self.addRoutes = function() {
      ...
      self.route('post', 'chooser-choices', function(req, res) {
        ...
        return async.series({
          ...
          var markup = self.render(req, choicesTemplate, { choices: choices, choiceTemplate: choiceTemplate, relationship: field.relationship, hints: field.hints });
