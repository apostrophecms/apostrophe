...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    // escaping.
    self.escapeIfNeeded = function(s) {
      if (!(s instanceof self.nunjucks.runtime.SafeString)) {
        return self.safe(self.apos.utils.escapeHtml((s == null) ? '' : s.toString()));
      } else {
        return s;
      }
    };
    ...
    self.addStandardFilters = function(env) {
      ...
      env.addFilter('nlbr', function (data) {
        ...
        data = self.apos.utils.globalReplace(data.toString(), '\n', '<br />\n');
      ...
      env.addFilter('nlp', function (data) {
        ...
        return self.apos.templates.safe(output);
      });
