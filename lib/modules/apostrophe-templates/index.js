...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.newEnv = function(req, moduleName, dirs) {
      ...
      self.addStandardExtensions(env);
    ...
    self.addStandardExtensions = function(env) {
      console.log('adding component extension');
      const ComponentExtension = require('./lib/nunjucks-extensions/component');
