...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    // Add a body attribute or attributes to be emitted when the page is rendered. This information
    // is attached to `req.data`, where the string `req.data.aposBodyDataAttributes` is built up.
    // The default `outerLayoutBase.html` template outputs that string.
    // The string passed may contain space-separated attribute names which are automatically prepended with "data-".

    self.addBodyDataAttribute = function(req, bodyAttribute) {
