...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.partialForModule = function(name, data, module) {
      ...
      return self.renderForModule(req, name, data, module);
    }
    ...
    self.partialStringForModule = function(name, data, module) {
      ...
      return self.renderStringForModule(req, name, data, module);
    }
    ...
    self.addStandardFilters = function(env) {
      ...
      env.addFilter('pruneTemporaryProperties', function(o) {
        var result = self.apos.utils.pruneTemporaryProperties(o);
        return result;
      });
    ...
    self.renderPageForModule = function(req, template, data, module) {
      ...
      req.browserCall('$(function() { setImmediate(function() { apos.emit("ready"); }); })');
