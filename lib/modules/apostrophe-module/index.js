...
module.exports = {
  ...
  methods(self, options) {
    return {
      ...
      async createRelatedClass(tool, options) {
      ...
      // any async init functions or an exception is thrown.
      createRelatedClassSync(tool, options) {
  ...
  helpers(self, options) {
    return {
      getOption: function(dotPath, def) {
        // In a helper called from nunjucks, req is
        // this.ctx.req
        console.log('***', this);
        self.getOption(this.ctx.req, dotPath, def);
      }
    };
  }
