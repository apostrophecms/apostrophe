...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.on = function(name, methodName, fn) {
      var moduleName, methodName, index;
      index = name.indexOf(':');
      if (_.camelCase(name) === _.camelCase(methodName)) {
        throw new Error('The method name ' + methodName + ' is essentially identical to the event name, ' + name + '. You must give it a distinct name expressing what it actually does with the event.'); 
      }
