...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.apiRoute = function(method, path, fn) {
      self.route(method, path, async function(req, res) {
        try {
          ...
          let data;
          if (err && err.type === 'apostrophe-http-error') {
            data = err.data;
            err = err.name;
          }
          ...
          res.status(self.apos.http.errors[err] || 500);
    ...
    self.render = async function(req, name, data) {
      ...
      return await self.apos.templates.renderForModule(req, name, data, self);
    };
    ...
    self.renderString = async function(req, s, data) {
      ...
      return await self.apos.templates.renderStringForModule(req, s, data, self);
    };
    ...
    self.renderer = function(name, data) {
      return async function(req, _data) {
        ...
        return await self.render(req, name, _data);
      };
    };
    ...
    self.renderPage = async function(req, template, data) {
      return await self.apos.templates.renderPageForModule(req, template, data, self);
    };
    ...
    self.createRelatedClass = async function(tool, options) {
      return await self.apos.synth.create(self.__meta.name + '-' + tool, options);
    };
    ...
    self.createRelatedClassSync = (tool, options) {
    ...
    self.email = async function(req, templateName, data, options) {
      return await self.apos.modules['apostrophe-email'].emailForModule(req, templateName, data, options, self);
    };
