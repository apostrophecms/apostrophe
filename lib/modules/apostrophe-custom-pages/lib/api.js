...
module.exports = function(self, options) {
  ...
  let superGetAutocompleteProjection = self.getAutocompleteProjection;
  self.getAutocompleteProjection = function(query) {
    let projection = superGetAutocompleteProjection(query);
    projection.slug = 1;
    return projection;
  };
  ...
  let superComposeSchema = self.composeSchema;
