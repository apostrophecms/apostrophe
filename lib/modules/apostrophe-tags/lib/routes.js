...
module.exports = function(self, options) {
  ...
  self.routes.listTags = function(req, res) {
    var contains = self.launder(req.body.contains);
    var data = {};
    return async.series({
      before: function(callback) {
        return self.beforeListTags(req, contains, callback);
      },
      list: function(callback) {
        return self.listTags(req, contains, function(err, results) {
          if (err) {
            return callback(err);
          }
      ...
      after: function(callback) {
        return self.afterListTags(req, contains, callback);
      }
    }, function(err) {
      if (err) {
