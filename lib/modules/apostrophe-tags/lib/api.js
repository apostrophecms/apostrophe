...
module.exports = function(self, options) {
  ...
  self.listTags = function(req, callback) {
    var contains = self.apos.launder.string(req.body.contains);
    var criteria = {};
    if (contains.length) {
  ...
  self.addTag = function(req, callback) {
  ...
  self.renameTag = function(req, callback) {
    return callback();
  };

  self.deleteTag = function(req, callback) {
    var tag = self.apos.launder.filterTag(self.apos.launder.string(req.body.tag));
