...
module.exports = function(self, options) {
  ...
  self.routes.editor = function(req, res) {
    return res.send(self.render(req, 'editor', { options: self.options, schema: self.allowedSchema(req) }));
  };

  self.routes.create = function(req, res) {
    return res.send(self.render(req, 'create', { options: self.options, schema: self.allowedSchema(req) }));
  };
