module.exports = function(self, options) {
  ...
  //   return async.series({
  //     before: function(cb) {
  //       return self.beforeList(req, filters, cb);
  //     },
  //     list: function(cb) {
  ...
  //     },
  //     after: function(cb) {
  //       return self.afterList(req, results, cb);
  //     }
  //   }, function(err) {
  //     if (err) {
  ...
  //         }
  //       });
  //       if (_.includes(self.manageViews, req.body.manageView)) {
  ...
  //   return self.batchSimpleRoute(req, 'publish', function(req, piece, data, cb) {
  //     piece.published = true;
  //     return self.update(req, piece, cb);
  //   });
  // };
  ...
  //   return self.batchSimpleRoute(req, 'unpublish', function(req, piece, data, cb) {
  ...
  //   return self.batchSimpleRoute(req, 'tag', function(req, piece, data, cb) {
  //     if (!piece.tags) {
  //       piece.tags = [];
  //     }
  ...
  //   return self.batchSimpleRoute(req, 'untag', function(req, piece, data, cb) {
  //     if (!piece.tags) {
  ...
  //   return self.send(req, 'managerModal', { options: self.options, schema: self.schema });
  // };

  // self.routes.chooserModal = function(req, res) {
  //   var limit = self.apos.launder.integer(req.body.limit);
  //   return self.send(req, 'chooserModal', { options: self.options, limit: limit, schema: self.schema, chooser: true });
  // };

  // self.routes.editorModal = function(req, res) {
  //   var schema = self.allowedSchema(req);
  //   self.apos.schemas.bless(req, schema);
  //   return self.send(req, 'editorModal', { options: self.options, schema: schema });
  // };

  // self.routes.createModal = function(req, res) {
  //   var schema = self.allowedSchema(req);
  //   self.apos.schemas.bless(req, schema);
  //   return self.send(req, 'createModal', { options: self.options, schema: schema });
  // };
  ...
  //   if (req.body.job) {
  //     // New way
  //     return self.apos.modules['apostrophe-jobs'].run(req, function(req, id, cb) {
  //       return one(id, cb);
  //     }, {
  //       label: {
  //         title: 'Trash'
  ...
  //     return async.series({
  //       before: function(cb) {
  //         return self.beforeTrash(req, id, cb);
  //       },
  //       trash: function(cb) {
  //         return self.trash(req, id, cb);
  //       },
  //       after: function(cb) {
  //         return self.afterTrash(req, id, cb);
  //       }
  //     }, function(err) {
  ...
  //     return async.series({
  //       before: function(cb) {
  //         return self.beforeRescue(req, id, cb);
  //       },
  //       rescue: function(cb) {
  //         return self.rescue(req, id, cb);
  //       },
  //       after: function(cb) {
  //         return self.afterRescue(req, id, cb);
  //       }
  //     }, function(err) {
  ...
  //         return cb('unsuitable');
  //       }
  //       return cb(null);
  //     });
  //   }

  //   function insertPiece(cb) {
  //     if (!attachment) {
  //       return cb(null);
  //     }
  ...
  //     return self.insert(req, piece, cb);
  //   }
