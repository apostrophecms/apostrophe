...
module.exports = function(self, options) {
    ...
    return async.series({
      ...
      if ((!err) && (req.body.format === 'managePage')) {
        ...
        results = {
          ...
          resultLabel: self.render(req, 'manageResultLabel', results),
  ...
  self.routes.manage = function(req, res) {
    ...
    return res.send(self.render(req, 'manage', { options: self.options, schema: self.schema, chooser: !!req.body.chooser }));
  };
