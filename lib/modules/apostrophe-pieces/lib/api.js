...
console.log('Hello apostrophe pieces.')

module.exports = function(self, options) {

  // we need to alias this so that
  // we won't break backward compat
  self.addTrashPrefixFields = self.apos.modules['apostrophe-docs'].addTrashPrefixFields;
  ...
  self.trash = function(req, id, callback) {
    ...
    function body(callback) {
      ...
      return self.apos.docs.trash(req, id, {
        ...
        return self.apos.docs.deduplicateTrash(req, piece, callback);
      });
    }
  };
  ...
  self.rescue = function(req, id, callback) {
    ...
    function body(callback) {
      ...
      return self.apos.docs.rescue(req, id, {
        ...
        return self.apos.docs.deduplicateRescue(req, piece, callback);
      });
    }
  };
