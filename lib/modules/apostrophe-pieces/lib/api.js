...
module.exports = function(self, options) {
  ...
  // By implementing this doc manager method we get the ability to easily override
  // the presentation of each previously selected choice when editing a join just by
  // overriding chooserChoice.html. -Tom
  self.outputChooserChoice = function(choice, relationship) {
