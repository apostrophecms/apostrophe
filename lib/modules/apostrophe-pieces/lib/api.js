...
module.exports = function(self, options) {
  ...
  self.convert = function(req, piece) {
    await self.apos.schemas.convert(req, self.allowedSchema(req), 'form', req.body, piece);
  };
  ...
  // found in `piece` (hint: you can pass `req.body`
  ...
  self.convertInsertAndRefresh = async function(req, piece) {
    const piece = self.newInstance();
    const copyingId = piece._copyingId;
    await self.convert(req, piece);
    await self.afterConvert(req, piece);
    await copy();
    ...
    async function copy() {
      ...
      await self.copyExtras(req, copyOf, piece);
    }
  };
