  ...
  self.trash = function(req, id, callback) {
    ...
    function body(callback) {
      ...
      return self.apos.docs.trash(req, id, {
        ...
        return self.apos.docs.getManager(self.name).deduplicateTrash(req, piece, callback);
      });
    }
  };
  ...
  self.rescue = function(req, id, callback) {
    ...
    function body(callback) {
      ...
      return self.apos.docs.rescue(req, id, {
        ...
        return self.apos.docs.getManager(self.name).deduplicateRescue(req, piece, callback);
      });
    }
  };
