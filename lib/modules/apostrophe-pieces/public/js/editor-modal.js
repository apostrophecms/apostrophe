...
apos.define('apostrophe-pieces-editor-modal', {
  ...
  construct: function(self, options) {
    ...
    self.create = function(callback) {
      let piece = apos.schemas.newInstance(self.schema);
    ...
    self.saveContent = function(callback) {
      ...
      return async.series({
        ...
        let verb = piece._id ? 'update' : 'insert';
        if (self.copying) {
    ...
    self.copy = function($el) {
      ...
      let superDisplayResponse = self.displayResponse;
      self.displayResponse = function(result, callback) {
      ...
      return self.save(function(err) {
        ...
        // for a new piece
        let _options = _.clone(self.options);
