...
apos.define('apostrophe-pieces-manager-modal', {
  ...
  construct: function(self, options) {
      ...
      self.$el.on('change', '[data-piece] input[type="checkbox"]', function(e) {
        ...
        if ($box.prop('checked')) {
          if (!_.contains(self.choices, id)) {
            ...
            self.$el.find('[data-apos-bulk]').removeClass('apos-button--disabled');
          }
        } else {
          ...
          if (!self.choices.length) {
            ...
            self.$el.find('[data-apos-bulk]').addClass('apos-button--disabled');
          }
        }
      });
    };
    ...
    self.reflectChoicesInCheckboxes = function() {
      ...
      var $bulk = self.$el.find('[data-apos-bulk]');
      if (self.choices.length) {
        $bulk.removeClass('apos-button--disabled');
      } else {
        $bulk.addClass('apos-button--disabled');
      }
    };
