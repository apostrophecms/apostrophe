...
apos.define('apostrophe-pieces-manager-modal', {
  ...
  construct: function(self, options) {
    ...
    self.enableSuggestions = function() {

      self.$filters.on('keyup', `[name=search-${self.options.name}]`, function(e) {
        ...
        // listOptions.filters.autocomplete = $(target).val();
        ...
        self.api('suggestions', options, function(results) {
          if (results && results.length) {
            ...
            $search.find('.ui-menu-item').forEach(function (i, elem) {
