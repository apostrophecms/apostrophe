...
apos.define('apostrophe-pieces-manager-modal', {
  ...
  construct: function(self, options) {
    ...
    self.getBatchPermissions = function(data, callback) {
      return self.launchBatchPermissionsModal(data, callback);
    };

    self.launchBatchPermissionsModal = function(options, callback) {
      return apos.create('apostrophe-batch-permissions-modal',
