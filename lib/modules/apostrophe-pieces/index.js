    ...
    return {
      post: {
        async list(req) {
          ...
          const cursor = self.find(req).perPage(self.options.perPage).trash(null).published(null).applyBuildersSafely(filters, 'manage');
  ...
  methods(self, options) {
    return {
      ...
      findForEditing(req, criteria, projection) {
        let cursor = self.find(req, criteria, projection).permission('edit').published(null);
      ...
      async list(req, filters) {
        ...
        cursor.applyBuildersSafely(filters);
        const results = {};
        if (filters.format === 'allIds') {
      ...
      insertResponse(req, res, err, data) {
        return self.apiResponse(res, err, data);
      },
      updateResponse(req, res, err, data) {
        return self.apiResponse(res, err, data);
      },
      retrieveResponse(req, res, err, data) {
        return self.apiResponse(res, err, data);
      },
      listResponse(req, res, err, data) {
        return self.apiResponse(res, err, data);
      },
      trashResponse(req, res, err, data) {
        return self.apiResponse(res, err, data);
      },
      rescueResponse(req, res, err, data) {
        return self.apiResponse(res, err, data);
      },
      composeFilters() {
  ...
  helpers(self, options) {
    return {
      ...
      editControls: function () {
        ...
        return self.partial('controls', {
          controls: self.getEditControls(req),
      ...
      createControls: function () {
        let req = self.apos.templates.contextReq;
        return self.partial('controls', {
          controls: self.getCreateControls(req),
          options: self.options
        });
      },
      ...
      managerControls: function () {
        let req = self.apos.templates.contextReq;
        return self.partial('controls', {
          controls: self.getManagerControls(req),
          options: self.options
        });
      },
      ...
      chooserControls: function () {
        let req = self.apos.templates.contextReq;
        return self.partial('controls', {
          controls: self.getChooserControls(req),
          options: self.options
        });
      },
      // Obsolete
