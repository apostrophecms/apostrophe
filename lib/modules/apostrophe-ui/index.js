...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.pushAsset('stylesheet', 'vendor/font-awesome/fontawesome', { when: 'always' });
    self.pushAsset('stylesheet', 'vendor/font-awesome/solid', { when: 'always' });
    self.pushAsset('stylesheet', 'vendor/font-awesome/regular', { when: 'always' });
    self.pushAsset('stylesheet', 'vendor/font-awesome/brands', { when: 'always' });
