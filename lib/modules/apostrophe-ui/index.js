...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    if (options.fontAwesome === 5) {
      self.pushAsset('stylesheet', 'vendor/font-awesome5/fontawesome', { when: 'always' });
      self.pushAsset('stylesheet', 'vendor/font-awesome5/solid', { when: 'always' });
      self.pushAsset('stylesheet', 'vendor/font-awesome5/regular', { when: 'always' });
      self.pushAsset('stylesheet', 'vendor/font-awesome5/brands', { when: 'always' });
    } else {
      self.pushAsset('stylesheet', 'vendor/font-awesome4/font-awesome', { when: 'always' });  
    }
