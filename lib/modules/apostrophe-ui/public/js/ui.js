...
apos.define('apostrophe-ui', {
  ...
  construct: function(self, options) {
    ...
    self.enableTooltips = function() {
      ...
      $('[data-apos-tooltip]').hover(function() {
        var $this = $(this);
        var $newTooltip = $clone.clone();
        ...
        var $this = $(this);
        var $tooltip = $body.find('[data-apos-tooltip]:first');
      ...
      function restore($old, $new) {
        ...
        $new.contents().each(function() {
          ...
          if (is($node, 'preserve')) {
            ...
            var $nodeOld = findVal($old, 'preserves', attr($node, 'preserves'));
            if ($nodeOld.length) {
