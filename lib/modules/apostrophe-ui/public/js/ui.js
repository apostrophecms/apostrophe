...
apos.define('apostrophe-ui', {
  ...
  construct: function(self, options) {
    ...
    self.enhanceColorpicker = function($el, data, options) {
      ...
      if (data) {
        if (_.isString(data)) {
          console.log('populating a string');
          colorOptions.color = data;
        }
        if (colorOptions.stringFormat) {
          console.log('populating from tinyobj');
          colorOptions.color = data.stringFormat;
        }
      }
      ...
      if ($el.spectrum('get')) {
        populateColorpicker(colorOptions.color);
      } else {
        emptyColorpicker();
      }
