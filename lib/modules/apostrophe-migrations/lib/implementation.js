...
module.exports = function(self, options) {
  ...
  self.afterInit = function() {
    ...
    self.addCreatedByAndLastEditorMigration();
  };
  ...
  self.addCreatedByAndLastEditorMigration = function() {
    return self.apos.migrations.add('deduplicatePagesInTrash', function() {
      return Promise.try(function() {
        return self.eachDoc({
          ...
          return Promise.try(function() {
            return self.apos.versions.db.find({ docId: doc._id }).sort({ createdAt: -1 }).limit(1).toArray();
            ...
            return self.apos.docs.db.update({
              ...
              $set: {
                createdBy: versions[0].author,
                createdById: versions[0].authorId,
                lastEditor: versions[0].author,
                lastEditorId: versions[0].authorId
              }
            });
          });
        });
