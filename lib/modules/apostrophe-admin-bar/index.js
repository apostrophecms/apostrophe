...
module.exports = {
  ...
  construct: function(self, options) {
      ...
      _.each(self.options.groups || self.groups.concat(self.options.addGroups || []), function(group) {
        ...
        _.each(group, function(name, groupIndex) {
          ...
          if (name !== item.menuLeader) {
            ...
            const indexMe = _.findIndex(self.items, { name: name });
    ...
    // TODO this is a common use case for most modules,
    // refactor and reuse the logic

    self.on('apostrophe-pages:beforeSend', 'registerBrowserModule', function(req) {
