...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.pushAssets = function() {
      ...
      var closeDelay = self.apos.launder.integer(self.options.closeDelay);
      _.extend(options.browser, {
        openOnLoad: (!!(typeof self.options.openOnLoad === 'undefined' || self.options.openOnLoad)),
        openOnHomepage: (!!(typeof self.options.openOnHomepage === 'undefined' || self.options.openOnHomepage)),
        closeDelay: closeDelay > 0 ? closeDelay : 3000
      });
