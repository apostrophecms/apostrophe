  ...
  construct: function(self, options) {
    ...
    self.enableLinks = function() {
      ...
      self.link('relate', 'item', function($button, _id) {
        ...
        var editorType = self.field.relationshipEditor || 'apostrophe-docs-relationship-editor';
    ...
    self.launchBrowser = function() {
      return apos.docs.getManager(self.field.withType).getTool('manager-modal', { chooser: self });
    };
