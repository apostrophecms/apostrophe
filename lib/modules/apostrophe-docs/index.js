...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    //
    // docBeforeSave, docBeforeUpdate, docAfterSave and
    // docAfterUpdate are invoked on all modules.
    //
    ...
    self.update = function(req, idOrCriteria, doc, callback) {
      ...
      return async.series({
        ...
        update: function(callback) {
          return self.retryUntilUnique(req, doc, function(callback) {
            return self.db.update(criteria, doc, callback);
          }, callback);
        },
