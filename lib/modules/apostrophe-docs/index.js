...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.loadWidgets = function(req, doc, callback) {
      console.error('TODO: implement apos.docs.loadWidgets');
      return setImmediate(callback);
    };

    // Insert the given document. If the slug is not
    // unique it is made unique. apos.*.beforeInsertDoc
    // and apos.*.afterInsertDoc are called. On success
    ...
    self.insert = function(req, doc, callback) {
      ...
      return async.series({
        beforeInsertDoc: function(callback) {
          return self.apos.callMethodOfAllModules('beforeInsertDoc', doc, callback);
        },
          ...
          return async.whilst(
            ...
            function(callback) {
              return self.db.insert(doc, function(err) {
                ...
                // appropriate, etc.
                return self.apos.callMethodOfAllModules('fixUniqueErrorForDoc', doc, callback);
              });
            },
            callback
          );
        },
        afterInsertDoc: function(callback) {
          return self.apos.callMethodOfAllModules('afterInsertDoc', doc, callback);
        }
      }, callback);
    };
