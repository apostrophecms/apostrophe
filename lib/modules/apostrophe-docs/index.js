    ...
    self.insert = function(req, doc, callback) {
      return async.series({
        beforeInsert: function(callback) {
          return self.apos.callMethodOfAllModules('docBeforeInsert', req, doc, callback);
        },
        beforeSave: function(callback) {
          return self.apos.callMethodOfAllModules('docBeforeSave', req, doc, callback);
        },
        insert: function(callback) {
          return self.apos.callMethodOfAllModules('docInsert', req, doc, callback);
        },
        afterInsert: function(callback) {
          return self.apos.callMethodOfAllModules('docAfterInsert', req, doc, callback);
        },
        afterSave: function(callback) {
          return self.apos.callMethodOfAllModules('docAfterSave', req, doc, callback);
        }
      }, function(err) {
    ...
    self.update = function(req, doc, callback) {
      return async.series({
        beforeUpdate: function(callback) {
          return self.apos.callMethodOfAllModules('docBeforeUpdate', req, doc, callback);
        },
        beforeSave: function(callback) {
          return self.apos.callMethodOfAllModules('docBeforeSave', req, doc, callback);
        },
        update: function(callback) {
          return self.apos.callMethodOfAllModules('docUpdate', req, doc, callback);
        },
        afterUpdate: function(callback) {
          return self.apos.callMethodOfAllModules('docAfterUpdate', req, doc, callback);
        },
        afterSave: function(callback) {
          return self.apos.callMethodOfAllModules('docAfterSave', req, doc, callback);
        },
    ...
    self.trash = function(req, idOrCriteria, callback) {
      ...
      return async.series({
        ...
        beforeTrash: function(callback) {
          return self.apos.callMethodOfAllModules('docBeforeTrash', req, doc, callback);
        },
        trash: function(callback) {
          return self.apos.callMethod/OfAllModules('docTrash', req, doc, callback);
        },
        afterTrash: function(callback) {
          return self.apos.callMethodOfAllModules('docAfterTrash', req, doc, callback);
        },
      }, function(err) {
        return callback(err, (!err) && doc);
      });
    ...
    self.rescue = function(req, idOrCriteria, callback) {
      ...
      return async.series({
        ...
        beforeRescue: function(callback) {
          return self.apos.callMethodOfAllModules('docBeforeRescue', req, doc, callback);
        },
        rescue: function(callback) {
          return self.apos.callMethodOfAllModules('docRescue', req, doc, callback);
        },
        // Actual implementation of rescue is in our own
        // docAfterRescue method, which runs first
        afterRescue: function(callback) {
          return self.apos.callMethodOfAllModules('docAfterRescue', req, doc, callback);
        }
      }, callback);
    };
      ...
      return async.whilst(
        ...
        function(callback) {
          ...
          return actor(function(err) {
            ...
            return self.apos.callMethodOfAllModules('docFixUniqueError', req, doc, callback);
          });
        },
        callback
      );
