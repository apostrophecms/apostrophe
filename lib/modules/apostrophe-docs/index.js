...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.insert = function(req, doc, callback) {
      console.error('TODO: insert does not purge _ properties yet!');
      return async.series({
    ...
    self.update = function(req, doc, callback) {
      console.error('TODO: update does not purge _ properties yet!');
      return async.series({
    ...
    // Called for us by Cursor.afterLoad, as well
    ...
    self.docsAfterLoad = function(req, results) {
