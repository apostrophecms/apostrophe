...
module.exports = function(self, options) {
  ...
  self.route('post', 'chooser-choices', function(req, res) {
    ...
    return async.series({
      ...
      return res.send(self.render(req, 'chooserChoices', { choices: receptacle[field.name], outputChooserChoice: manager.outputChooserChoice, relationship: field.relationship } ));
    });
  });
  ...
  self.route('post', 'relationship-editor', function(req, res) {
    ...
    return res.send(self.render(req, 'relationshipEditor', { field: field }));
  });
