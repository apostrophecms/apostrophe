...
module.exports = function(self, options) {
  ...
  self.ensureIndexes = function(callback) {
    ...
    return async.series([ indexType, self.ensureSlugIndex, indexTitleSortified, indexUpdatedAt, indexTags, indexPublished, indexText, indexParkedId, indexAdvisoryLockId, self.ensurePathLevelIndex ], callback);
  ...
  self.lock = function(req, id, contextId, options, callback) {
    ...
    if (!options.force) {
      criteria['advisoryLock._id'] = {
        $in: [
          // as with the equality operator, null matches docs without the
          // property too. Potentially faster than $or
          contextId, null
        ]
      };
    }
