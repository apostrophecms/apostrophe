...
module.exports = function(self, options) {
  ...
  self.docBeforeInsert = function(req, doc, options) {
    ...
    doc.createdById = req.user && req.user._id;
    doc.createdBy = req.user && req.user.title;
  ...
  self.docBeforeSave = function(req, doc, options) {
    ...
    doc.lastEditorId = req.user && req.user._id;
    doc.lastEditor = req.user && req.user.title;
