  ...
  _.defaults(cursor, {
    ...
    toArray: function(callback) {
      return async.waterfall({
        mongo: cursor.toMongo,
        toArray: function(mongo, callback) {
        ...
        custom: function(results, callback) {
          var callbacks = [];
          self.apos.emit('loadDocs', cursor, results, callbacks);
          return async.eachSeries(callbacks, function(err) {
            return callback(err, (!err) && results);
          });
        }
      }, callback);
    ...
    finalize: function(callback) {
      ...
      return async.series({
        ...
        custom: function(callback) {
          ...
          return async.eachSeries(callbacks, callback);
        }
      }, callback);
    },
