...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    // Invoke afterDocsLoaded methods of all modules

    self.callAfterDocsLoaded = function(results, callback) {
      self.apos.callMethodOfAllModules('afterDocsLoaded', results, function(err) {
