      ...
      function afterPopulate() {
        ...
        function toggleHidden($select) {
          ...
          _.each($hideFieldOptions, function(hideFieldOption){
            var hideFields = $(hideFieldOption).attr('data-show-fields');
          ...
          var showFields = $select.siblings('.selectize-control').find('[data-selected]').attr('data-show-fields');
