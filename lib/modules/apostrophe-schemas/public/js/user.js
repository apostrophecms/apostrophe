...
apos.define('apostrophe-schemas', {
  ...
  construct: function(self, options) {
    ...
    self.showError = function($el, error) {
      ...
      if (error.fix) {
        var $fix = $('<a href="#" data-apos-fix-error="' + error.type + '" data-apos-fix-url="' + error.doc._url + '" data-apos-fix-id="' + error.doc._id + '" data-apos-fix-type="' + error.doc.type + '" class="apos-schema-fix fa fa-wrench"></a>');
        if (error.hint) {
