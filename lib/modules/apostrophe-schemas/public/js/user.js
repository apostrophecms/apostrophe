apos.define('apostrophe-schemas', {
  construct: function(self, options) {
    ...
    self.enableTags = function($el, tags, field) {
      ...
      $el.selective({ preventDuplicates: true, add: !apos.data.lockTags, data: tags, source: apos.tags.action + '/autocomplete', addKeyCodes: [ 13, 'U+002C'], limit: field.limit, sortable: field.sortable, nestGuard: '[data-selective]' });
    };
  }
});
