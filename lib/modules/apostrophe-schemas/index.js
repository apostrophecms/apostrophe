...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    // All arguments must be present, however relationshipsField
    // may be undefined to indicate none is needed.
    self.joinDriver = function(req, method, reverse, items, idField, relationshipsField, objectField, options) {
      if (!options) {
        options = {};
      }
      const find = options.find;
    ...
    self.join = async function(req, schema, objectOrArray, withJoins) {
