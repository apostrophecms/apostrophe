  ...
  construct: function(self, options) {
    ...
    self.addFieldType({
      ...
      validate: function(field, options, warn, fail) {
        ...
        var otherGuy = _.find(self.apos.docs.managers, { name: field.withType });
        if (!otherGuy) {
          fail('withType property, ' + field.withType + ', does not match the "name" property of any doc type. Hint: this is not the same thing as a module name. Usually singular.');
        }
        var forwardJoin = _.find(otherGuy.schema, { type: 'joinByOne', idField: field.idField });
        if (!forwardJoin) {
    ...
    self.addFieldType({
      ...
      validate: function(field, options, warn, fail) {
        ...
        var forwardJoin = _.find(otherGuy.schema, { type: 'joinByArray', idsField: field.idsField });
        if (!forwardJoin) {
