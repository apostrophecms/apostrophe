  ...
  init(self, options) {
    ...
    self.addFieldType({
      ...
      addQueryBuilder: function (field, query) {
        query.addQueryBuilder(field.name, {
          finalize: function () {
    ...
    return {
      ...
      joinDriver(req, method, reverse, items, idField, relationshipsField, objectField, options) {
        ...
        return method(items, idField, relationshipsField, objectField, function (ids) {
          ...
          // Builders hardcoded as part of this join's blessed options don't
          ...
          query.applyBuildersSafely(hints, 'manage');
      ...
      // this is done even if such a query builder is already present on the query object.
      
      addQueryBuilders(schema, options, query) {
        _.each(schema, function (field) {
