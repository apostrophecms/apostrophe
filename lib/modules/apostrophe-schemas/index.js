        ...
        cursor.addFilter(field.name, {
          finalize: function() {
            ...
            if (Array.isArray(value)) {
              ...
              // null matches either nonexistent or null in mongo equality tests. -Tom
              criteria[field.idField] = null;
            } else {
          ...
          return cursor.addFilter(field.name + suffix, {
            finalize: function() {
              ...
              if (Array.isArray(value)) {
                ...
                // In a MongoDB equality test this will match if the property or
                // its parent is nonexistent, as well. -Tom
                criteria[field.idsField + '.0'] = null;
              } else {
