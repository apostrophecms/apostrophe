        ...
        _.each(errors, function(err, name) {
          if ((typeof err) === 'string') {
            if ((err === 'required') && (!self.isVisible(schema, object, name))) {
              ...
              self.apos.utils.warn('Field ' + field.name + ' reported a validation error for the value ' + JSON.stringify(data) + ', tolerant sanitization in effect, delivering default');
