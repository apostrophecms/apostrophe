...
module.exports = {
  construct: function(self, options) {
    ...
    self.converters.csv = {
      ...
      joinByOne: function(req, data, name, snippet, field, callback) {
        var manager = self.apos.documents.getManager(field.withType);
        if (!manager) {
    ...
    self.converters.form.singleton = self.converters.form.area = function(req, data, name, snippet, field, callback) {
      ...
      return self.apos.areas.sanitize(req, content, function(err, items) {
        if (err) {
          return callback(err);
        }
    ...
    self.converters.form.joinByArray = function(req, data, name, snippet, field, callback) {
      snippet[field.idsField] = self.apos.launder.id(data[field.idsField]);
    ...
    self.converters.form.tags = function(req, data, name, snippet, field, callback) {
      ...
      console.error('TODO: implement tags module server side, then uncomment relevant code in schema converter for tags');
      return setImmediate(callback);
    ...
    self.joinrs = {
      joinByOne: function(req, field, objects, options, callback) {
        return self.joinDriver(req, 'byOne', false, objects, field.idField, undefined, field.name, options, callback);
      },
      joinByOneReverse: function(req, field, options, objects, callback) {
        return self.joinDriver(req, 'byOneReverse', true, objects, field.idField, undefined, field.name, options, callback);
      },
      joinByArray: function(req, field, options, objects, callback) {
        return self.joinDriver(req, 'byArray', false, objects, field.idsField, field.relationshipsField, field.name, options, callback);
      },
      joinByArrayReverse: function(req, field, options, objects, callback) {
        return self.joinDriver(req, 'byArrayReverse', false, objects, field.idsField, field.relationshipsField, field.name, options, callback);
      },
    };
  ...
  self.joinDriver = function(req, method, reverse, items, idField, relationshipsField, objectField, options, callback) {
    ...
    var getter = options.get || self.apos.documents.get;
      ...
      schemas: {
        field: function(field) {
          ...
          if (!partial) {
            ...
            // of this module
            return self.partialer(field.type)(field).trim();
          }
          return partial(field).trim();
        }
      }
    });
