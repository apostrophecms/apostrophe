...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.converters = {};
    self.converters.csv = {
      area: function(req, data, name, object, field, callback) {
      ...
      password: function(req, data, name, object, field, callback) {
        if (data[name]) {
          object[name] = self.apos.launder.string(data[name], field.def);
        }
        return setImmediate(callback);
      ...
      // (no slashes at all)
      slug: function(req, data, name, object, field, callback) {
        var options = {};
        if (field.page) {
          options.allow = '/';
        }
      ...
      tags: function(req, data, name, object, field, callback) {
        var tags;
        tags = self.apos.launder.tags(data[name]);
        object[name] = tags;
        return setImmediate(callback);
      },
      boolean: function(req, data, name, object, field, callback) {
      ...
      radioTable: function(req, data, name, object, field, callback) {
        object[name] = {}; // set this to an empty object for now
        return setImmediate(function() {
          return callback(null);
        });
      },
      select: function(req, data, name, object, field, callback) {
        object[name] = self.apos.launder.select(data[name], field.choices, field.def);
        return setImmediate(callback);
      },
      integer: function(req, data, name, object, field, callback) {
        object[name] = self.apos.launder.integer(data[name], field.def, field.min, field.max);
        return setImmediate(callback);
      },
      float: function(req, data, name, object, field, callback) {
        object[name] = self.apos.launder.float(data[name], field.def, field.min, field.max);
        return setImmediate(callback);
      },
      url: function(req, data, name, object, field, callback) {
        object[name] = self.apos.launder.url(data[name], field.def);
        return setImmediate(callback);
      },
      date: function(req, data, name, object, field, callback) {
        object[name] = self.apos.launder.date(data[name], field.def);
        return setImmediate(callback);
      },
      time: function(req, data, name, object, field, callback) {
        object[name] = self.apos.launder.time(data[name], field.def);
        return setImmediate(callback);
      },
      group: function(req, data, name, object, field, callback) {
        // This is a visual grouping element and has no data
        return setImmediate(callback);
      },
      array: function(req, data, name, object, field, callback) {
      ...
      // is tolerant
      joinByOne: function(req, data, name, object, field, callback) {
      ...
      joinByArray: function(req, data, name, object, field, callback) {
        var manager = self.apos.docs.getManager(field.withType);
        if (!manager) {
          return callback(new Error('join with type ' + field.withType + ' unrecognized'));
        }
      ...
      joinByOneReverse: function(req, data, name, object, field, callback) {
        // Importable as part of the *other* type
        return setImmediate(callback);
      },
      joinByArrayReverse: function(req, data, name, object, field, callback) {
        // Importable as part of the *other* type
        return setImmediate(callback);
      },
    };
    ...
    self.converters.form.singleton = self.converters.form.area = function(req, data, name, object, field, callback) {
      var items = [];
    ...
    self.converters.form.radioTable = function(req, data, name, object, field, callback) {
    ...
    self.converters.form.array = function(req, data, name, object, field, callback) {
    ...
    self.converters.form.joinByOne = function(req, data, name, object, field, callback) {
      object[field.idField] = self.apos.launder.id(data[field.idField]);
      return setImmediate(callback);
    };

    self.converters.form.joinByOneReverse = function(req, data, name, object, field, callback) {
      // Not edited on this side of the relation
      return setImmediate(callback);
    };

    self.converters.form.joinByArray = function(req, data, name, object, field, callback) {
      ...
      if (field.relationshipsField) {
        ...
        _.each(object[field.idsField], function(id) {
          ...
          _.each(field.relationship, function(attr) {
            if (attr.type === 'string') {
              ...
              console.error(object.name + ': unknown type for attr attribute of relationship ' + name + ', ignoring');
            }
          });
    ...
    self.converters.form.joinByArrayReverse = function(req, data, name, object, field, callback) {
      // Not edited on this side of the relation
      return setImmediate(callback);
    };

    self.converters.form.tags = function(req, data, name, object, field, callback) {
    ...
    self.exporters.csv = {
      ...
      select: function(req, object, field, name, output, callback) {
        output[name] = object[name] || '';
        return setImmediate(callback);
      },
      slug: function(req, object, field, name, output, callback) {
        // no formating, set the field
        output[name] = object[name];
        return setImmediate(callback);
      },
      tags: function(req, object, field, name, output, callback) {
        output[name] = object[name].toString();
        return setImmediate(callback);
      },
      boolean: function(req, object, field, name, output, callback) {
        output[name] = self.apos.launder.boolean(object[name]).toString();
        return setImmediate(callback);
      },
      group: function(req, object, field, name, output, callback) {
        // This is a visual grouping element and has no data
        return setImmediate(callback);
      },
      a2Groups: function(req, object, field, name, output, callback) {
        // This is a visual grouping element and has no data
        return setImmediate(callback);
      },
      password: function(req, object, field, name, output, callback) {
        // don't export
        return setImmediate(callback);
      },
      a2Permissions: function(req, object, field, name, output, callback) {
        // don't export
        return setImmediate(callback);
      },
    }
    ...
    // Return a string of text  which can be compared to another
    // instance of this field to generate a useful diff. The string
    // should be user-readable text which jsdiff can analyze.
    //
    // These methods provide support to the apostrophe-versions module.
    //
    // If a field has no diffable, apostrophe-versions uses its
    // indexer instead, if available.

    self.diffables = {
      url: function(object, field) {
    ...
    self.export = function(req, schema, to, object, object, callback) {
      return async.eachSeries(schema, function(field, callback) {
        ...
        return self.exporters[to][field.type](req, object, field, field.name, object, function(err) {
          return callback(err);
        });
      }, function(err) {
        return callback(err);
