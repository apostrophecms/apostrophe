  ...
  handlers(self, options) {
    return {
      ...
      'apostrophe:afterInit': {
        async addCsrfAndFindModuleMiddleware() {
  ...
  middleware(self, options) {
    return {
      ...
      requiredMiddleware() {
        ...
        // TODO pick up here moving this stuff into middleware(self, options)
  ...
  methods(self, options) {
    return {
      ...
      async compileCsrfExceptions() {
        let list = self.options.csrf && self.options.csrf.minimumExceptions || [
          '/login',
          '/password-reset',
