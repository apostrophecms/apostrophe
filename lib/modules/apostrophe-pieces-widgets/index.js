...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.loadManyById = async function(req, widgets) {
    ...
    self.loadOthersOneAtATime = async function(req, widgets) {
      for (const widget of widgets) {
    ...
    self.loadOne = async function(req, widget) {
    ...
    self.loadOtherJoins = async function(req, widgets) {
    ...
    self.afterLoadOne = async function(req, widget) {
    };
