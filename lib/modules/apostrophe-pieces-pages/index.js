...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.indexPage = function(req, callback) {
      ...
      // TODO default value of cursor doesn't get assigned until cursor is
      // finalized, and toCount clones the original cursor before finalizing,
      // so we are required to set a default 'page' here if we want count
      // to properly get totalPages
      if (!cursor.get('page')) {
        cursor.page(1);
      }
