  ...
  construct: function(self, options) {
    ...
    self.refresh = function($permissionGroup) {
      ...
      if ($admin.prop('checked')) {
        $permissionGroup.find('[data-nuanced] input[type="checkbox"]').prop('readOnly', true).prop('checked', false);
        console.log($permissionGroup.find('[data-nuanced]').length);
        $permissionGroup.find('[data-nuanced]').addClass('apos-permissions-disabled');
      } else {
        $permissionGroup.find('[data-nuanced] input[type="checkbox"]').prop('readOnly', false);
