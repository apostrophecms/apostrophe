...
module.exports = function(self, options) {
  ...
  self.on('apostrophe-doc-type-manager:afterSave', 'addVersion', function(req, doc, options) {
  ...
  self.compare = async function(req, doc, version1, version2) {
    ...
    let docTypes = _.uniq(_.pluck(joined, 'docType'));
