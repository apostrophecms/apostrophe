...
// the potentially confusing concept of "users" who shouldn't actually be
// allowed to log in**.
//
...
//
// ::: tip
// To bring the `published` field back for the `apostrophe-users` piece type,
// set the `defaultRemoveFields`, `defaultRemoveFilters`, and
// `defaultRemoveColumns` properties on that module to an empty array.
// :::
//
// ### `secrets` option
//
...
module.exports = {
  ...
  beforeConstruct: function(self, options) {
    ...
    options.defaultRemoveColumns = options.defaultRemoveColumns || [ 'published' ];
  ...
  construct: function(self, options) {
    ...
    self.ensureGroup = function(group, callback) {
      ...
      return self.apos.locks.withLock(self.__meta.name + ':ensureGroup', function(callback) {
