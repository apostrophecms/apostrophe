    ...
    return {
      post: {
        async uniqueUsername(req) {
          ...
          const user = self.find(req, { username: username }).projection({
            _id: 1,
            username: 1
          }).toObject();
          if (user) {
