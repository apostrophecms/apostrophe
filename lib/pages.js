...
module.exports = function(self) {
  ...
  //
  // If Apostrophe's global "workflow" option is true, this method will
  // push your updates into a "draft" object property of the page rather than
  // directly updating the live properties of the page, unless the
  // "version" option is set to false when calling this method.
  // PLEASE NOTE: this discards any outstanding drafts.
  //
