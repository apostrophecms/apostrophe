...
module.exports = function(self) {
  ...
  // with other criteria using $and. Set options.editable to return
  // only pages the user can edit. See also `self.pagePermissions` below
  ...
  self.pagePermissions = function(req, action, page, callback) {
    ...
    if (action.match(/^publish\-/)) {
      ...
      callback = function(err) {
        ...
        return self.permissions(req, action, null, mainCallback);
      };
    }
