...
module.exports = function(self) {
  function setupPages(callback) {
    self.db.collection('aposPages', function(err, collection) {
      ...
      async.series([indexType, indexSlug, indexPath, indexSortTitle, indexStartDate, indexTags, indexPublished, indexText], callback);
   ...
   * properties (`apos.pages`, `apos.videos`, `apos.files`, `apos.versions`, `apos.redirects`).
   */
  self.initCollections = function(callback) {
    return async.series([setupPages, setupVersions, setupFiles, setupVideos, setupRedirects, setupCache ], callback);
  };
