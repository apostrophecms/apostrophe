...
module.exports = function(self) {
  ...
  function setupPages(callback) {
    self.db.collection('aposPages', function(err, collection) {
      ...
      // TODO: we clearly need separate collections per content type as sooner or
      // later conflict over how to index properties of the same name is going
      // to cause a problem
      ...
      async.series([indexType, indexSlug, indexPath, indexSortTitle, indexStartDate, indexTags, indexPublished, indexText, indexGeo], callback);
