  ...
  function setupPages(callback) {
    self.db.collection('aposPages', function(err, collection) {
      ...
      function indexPath(callback) {
        ...
        self.pages.ensureIndex({ type: 1 }, { safe: true, unique: true, sparse: true }, callback);
      }
      ...
      async.series([indexType, indexSlug, indexPath, indexSortTitle, indexStartDate, indexTags, indexPublished], callback);
