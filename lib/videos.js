    ...
    return oembed.fetch(url, {}, function (err, result) {
      if (err) {
        ...
        if (url.match(/youtube/)) {
          ...
          //Grabbing the better quality thumbnail
          maxResImage = result.thumbnail_url.replace('hqdefault.jpg', 'maxresdefault.jpg');
          request(maxResImage, function (error, response, body) {
