...
module.exports = function(self) {
  ...
  oembetter.addBefore(function(url, options, response, callback) {
    return async.series({
      ...
      return callback(null, url, options, { type: 'rich', html:
  ...
  oembetter.addBefore(function(url, options, response, callback) {
    ...
    return callback(null, url, options, { thumbnail_url: 'https://infogr.am/infogram.png', title: 'Infogram', type: 'rich', html: '<div id="' + anchorId + '"></div>' + afterScriptLoads("//e.infogr.am/js/embed.js", anchorId, 'infogram_0_' + slug, ';')
    });
  });
