...
module.exports = function(self) {
  self._aposLocals = {
    ...
    aposGroupByArray: function(items, arrayName){
      var results = {};
      _.each(items, function(item) {
