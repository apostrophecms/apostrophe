  ...
  self._aposLocals = {
    ...
    aposStylesheets: function(when) {
      ...
      if (self.options.minify) {
        return '<link href="' + self.prefix + '/css/minified-' + when + '-' + self._generation + '.css" rel="stylesheet" />';
      } else {
    ...
    aposScripts: function(when) {
      ...
      if (self.options.minify) {
        ...
        result += '<script src="' + self.prefix + '/js/minified-' + when + '-' + self._generation + '.js"></script>\n' + setScene();
        return result;
      } else {
