...
module.exports = function(self) {
  self._aposLocals = {
    ...
    aposItemNormalView: function(item, options) {
      ...
      var data = { item: item, itemType: itemType, options: options, jsonOptions: jsonOptions, attributes: attributes, alwaysEditing: self.alwaysEditing };
      var response = self.partial('itemNormalView', { item: item, itemType: itemType, options: options, jsonOptions: jsonOptions, attributes: attributes, alwaysEditing: self.alwaysEditing });
      return response;
    },
