  ...
  self._aposLocals = {
    ...
    aposStylesheets: function(when) {
      ...
      if (self.options.minify) {
        return '<link href="' + self.prefix + '/apos/stylesheets.css?pid=' + self._pid + '&when=' + when + '" rel="stylesheet" />';
      } else {
    ...
    aposScripts: function(when) {
      ...
      if (self.options.minify) {
        ...
        result += '<script src="' + self.prefix + '/apos/scripts.js?pid=' + self._pid + '&when=' + when + '"></script>\n' + setScene();
        return result;
      } else {
      ...
      function prefix() {
        return "<script>apos.data = { prefix: " + JSON.stringify(self.prefix) + " };</script>";
      }
    },
    ...
    // Returns true if the list contains an object with the specified property.
