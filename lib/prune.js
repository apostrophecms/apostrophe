...
module.exports = function(self) {
  ...
  // This method makes a deep copy of an object retaining only properties
  // that are considered worth sending to the browser as JSON on
  // every page request. A great deal of voluminous information
  // is removed to avoid extremely slow page renders. Note that
  // the existing object is not modified, which differs from the
  // behavior of pruneDeep and pruneTemporaryProperties.
  //
  // TODO: this method should post an event allowing other modules
  // to influence what is included.

  self.prunePage = function(page) {
    page = _.omit(page, 'tabs', 'ancestors', 'children', 'peers', 'lowSearchText', 'highSearchText', 'searchSummary', 'preMigrationAreas', 'legacyPermissions');
