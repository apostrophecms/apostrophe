 ...
 * functionality which is essentially a core part of JavaScript when developing Apostrophe,
 * such as escaping HTML, doing global replaces of strings, converting a
 * string to a slug, converting a string to a regular expression that searches
 * for it, converting a mixed case name to a hyphenated ("CSS") name, etc. Busting these
