...
module.exports = function(self, callback) {
  ...
  async.series([ addTrash, moveTrash, moveSearch, trimTitle, trimSlug, fixSortTitle, fixObjectId, explodePublishedAt, missingImageMetadata, missingFileSearch, fixNullTags, fixNumberTags, fixTimelessEvents, normalizeFiles, fixButtons, fixCrops, migrateEventDescrToBody, migrateTypeSettings ], function(err) {
    return callback(err);
  });
};
