...
module.exports = function(self) {
  ...
  self.mixinModuleEmail = function(module) {
    module.email = function(req, res, from, to, subject, template, data, callback) {
      ...
      return module._mailer.sendMail({
        ...
        to: fixAddress(to),
        subject: module.renderString(subject, finalData, req, res),
        text: module.render(template + '.txt', finalData, req, res),
        html: module.render(template + '.html', finalData, req, res)
      }, callback);
    };
