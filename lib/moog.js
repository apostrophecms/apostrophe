...
module.exports = function(options) {
  ...
  self.create = async function(className, _options) {
    ...
    // This needs to be after the options and fields sections so it can manipulate
    ...
    // afterInit is called last and has access to self.routes, etc.
    ...
    // implementation of afterInit to actually add the routes and handlers
    // to the system
    for (const step of steps) {
      if (step.afterInit) {
        await step.afterInit(that, options);
      }
    }
