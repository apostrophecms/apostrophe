...
module.exports = function(self) {
  ...
  // "q" option to apos.get and everything layered on top of it).

  self.sortify = function(s) {
    return self.slugify(s, { separator: ' ' });
  };

  // DEPRECATED: we are migrating toward MongoDB full text search as
  // a replacement for these built-in searches. use the "q" option
  // to apos.get and everything layered on top of it.
  //
