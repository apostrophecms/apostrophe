...
describe('Permissions', function() {
  ...
  describe('test permissions.can', function() {
    ...
    it('permits view-doc for unpublished doc for individual with group id for editing and the edit permission for the type', function() {
      return criteriaTest(req({ user: { _id: 1, groupIds: [ 1001, 1002 ], _permissions: { 'edit-turkey': true } } }), 'view-doc', 'edit1002', true);
    });
    ...
    it('permits edit-doc for individual with the admin-turkey permission', function() {
      return criteriaTest(req({ user: { _id: 1, _permissions: { 'admin-turkey': true } } }), 'edit-doc', 'edit1002', true);
    });
    it('permits edit-doc for individual with group id for edit- and the edit-turkey permission', function() {
      return criteriaTest(req({ user: { _id: 1, groupIds: [ 1001, 1002 ], _permissions: { 'edit-turkey': true } } }), 'edit-doc', 'edit1002', true);
    });
    it('forbids edit-doc for individual with group id for editing but no edit-turkey permission', function() {
      return criteriaTest(req({ user: { _id: 1, groupIds: [ 1001, 1002 ] } }), 'edit-doc', 'edit1002', false);
    });
    it('forbids edit-doc for other person', function() {
      return criteriaTest(req({ user: { _id: 7 } }), 'edit-doc', 'edit1002', false);
    });
    it('permits edit-doc for an admin', function() {
      return criteriaTest(req({ user: { _id: 1, _permissions: { 'admin': true } } }), 'edit-doc', 'edit1002', true);
    });
    it('forbids edit-doc for individual with group id for edit- and the edit-turkey permission if turkeys are adminOnly', function() {
      apos.modules.turkeys.options.adminOnly = true;
      return criteriaTest(req({ user: { _id: 1, groupIds: [ 1001, 1002 ], _permissions: { 'edit-turkey': true } } }), 'edit-doc', 'edit1002', false);
    });
    it('still permits edit-doc for an admin when turkeys are adminOnly', function() {
      return criteriaTest(req({ user: { _id: 1, _permissions: { 'admin': true } } }), 'edit-doc', 'edit1002', true);
    });
